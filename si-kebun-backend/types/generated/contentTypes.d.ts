...
export interface ApiPlantCategoryPlantCategory
  extends Struct.CollectionTypeSchema {
  collectionName: 'plant_categories';
  info: {
    displayName: 'plant-category';
    pluralName: 'plant-categories';
    singularName: 'plant-category';
  };
  options: {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::plant-category.plant-category'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    plantCategoryID: Schema.Attribute.UID<'name'>;
...
export interface ApiPlantPlant extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    growthTime: Schema.Attribute.String;
    imageUrl: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::plant.plant'> &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    plant_category: Schema.Attribute.Relation<
      'manyToOne',
      'api::plant-category.plant-category'
    >;
    plantID: Schema.Attribute.UID<'name'>;
    publishedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::plant-category.plant-category': ApiPlantCategoryPlantCategory;
